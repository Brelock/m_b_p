<template>
	<div :class="['cart-item', className]">
			...
			<div>
				<div class="imgWrapper">
					<img :src="getProdImgSrc(itemData.product.pictures[0], itemData.product.id,
						/*'picture_thumb_file_name'*/)" alt="prod img error">
				</div>
			</div>
		</div>
			...
			<div>
				<div class="product-category">
					<nuxt-link class="grey-highlight" 
						...
						v-text="itemData.product.category[`title_${$i18n.locale}`]"></nuxt-link>
				</div>
				<div class="product-title">
					<nuxt-link
						...
						v-text="itemData.product[`title_${$i18n.locale}`]"></nuxt-link>
				</div>
			</div>
		</div>
		...
		<div class="tableCell relative">
			...
			<div>
				<div class="price" v-text="`${itemData.amount} грн`"></div>
			</div>
		</div>

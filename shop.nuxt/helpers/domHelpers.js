const dropDown = (e, { onlyMobile, recalculateHeight, target, timeout }) => {
	...
	const targetBlock = document.getElementById(options.target);
	// console.log(options)
...
const toggleSubMenu = ({target}) => {
	target.nextElementSibling.classList.contains('js_showSlide') ? 
		null : target.nextElementSibling.classList.add('js_showSlide');

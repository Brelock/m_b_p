    ...
    <div class="modal__content">
      ...
      <form class="modal-body modal_body standard-form" id="modal_question_body_partner" data-form-type="1">
        ...
        {{-- <fieldset class="formRow">
          <div class="formRow--item">
            <label for="#" class="formRow--input-wrapper js-inputWrapper">
              ...
              <input type="email" placeholder="{{ __('question-form.your_mail') }}" autocomplete="off" data-doptext=""
                class="formRow--input js-input"
                required
                data-replace-required-for="phone"
                name="email"
                data-error-text="{{ __('question-form.valid_email') }}"
                initial-scale=1.0
                maximum-scale=1.0
              >
            </label>
        ...
        <fieldset class="formRow">
          <div class="formRow--item">
            <label for="#" class="formRow--input-wrapper js-inputWrapper">
              <input type="text" placeholder="{{ __('question-partner-form.сompany_name') }}" autocomplete="off" data-doptext=""
                class="formRow--input js-input"
                name="quantity"
                required
                data-replace-required-for="email"

    ...
    <div class="modal__content">
      ...
      <form class="modal-body" id="modal_companies_form">
        <div class="modal-inputs-wrap">
          ...
          @if(Route::currentRouteName() == 'credit')
            <fieldset class="formRow">
              <div class="formRow--item">
                <label class="formRow--input-wrapper js-inputWrapper">
                  <input name="credit-date" type="number" class="formRow--input js-input for_message_field"
                    placeholder="{{ __('discussion-form.loan_terms') }}" autocomplete="off" data-doptext=""
                    data-label-name="{{ __('discussion-form.loan_terms') }}"
                    initial-scale=1.0
                    maximum-scale=1.0
                  >
                </label>

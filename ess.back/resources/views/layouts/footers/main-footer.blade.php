<footer class="mainFooter section">
    ...
    <div class="discussion-question__bgc">
      <div class="discussion-question__form-wrap">
        ...
        <div class="form-wraper">
          ...
          <form action="#" class="project-cost__form visible-viewportchecker visibility--check" id="project_cost__form" data-form-type="2">
            <label for="#">
              <input type="text" name="name" placeholder="{{ __('main-footer.your_name') }}" autocomplete="off" required
           ...
           {{-- <label for="#">
            ...
            <div class="ess-section-btn find_cost_btn"
              data-form-target="project_cost__form" >
              <div class="spinner">
                <div class="lds-dual-ring small"></div>
              </div>
              <button type="submit">{{ __('main-footer.find_cost') }}</button>
            </div>

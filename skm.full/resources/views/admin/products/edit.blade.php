        ...
        $("div#photo-dropzone").dropzone({
            ...
            init: function () {
                this.on("maxfilesexceeded", function(file) {
                    ...
                    @if( $product->getMedia('main_image'))
                var files = {!! json_encode($product->getMedia('main_image')) !!};
        ...
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-white">
                    <h3 class="block-title"><span id="titleModal">Редактировать товар :</span></h3>
                </div>
                <div class="block-content">
                    <div class="row justify-content-center pb-20">
                        <div class="col-xl-12">
                            <form class="js-validation-material" action="{{ route('admin.products.update', $product->slug) }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('put')
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <div class="form-material">
                                            <input type="text" value="{{ $product->title }}" class="form-control" id="category-title-ru" name="title" required>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <div class="d-flex align-items-center">
                                            <input type="checkbox" class="checkbox-inp" id="status" name="status" {{ $product->status == 1 ? 'checked' : '' }}>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <div class="d-flex align-items-center">
                                            <input type="checkbox" class="checkbox-inp" id="new" name="new" {{ $product->new == 1 ? 'checked' : ''}}>
                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-6">
                                        <div class="d-flex align-items-center">
                                            <input type="checkbox" class="checkbox-inp" id="popular" name="popular" {{ $product->popular == 1 ? 'checked' : ''}}>

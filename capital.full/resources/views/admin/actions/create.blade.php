    ...
    <form method="POST"
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    ...
                    <span><small>будет отображаться в списке акций (418 * 320 px)</small></span>
                    <input type="file" name="photo" class="form-control-file border" @if(!isset($action->photo))  @endif/>
                </div>
            </div>
            <div class="col-sm-4">
                <h5>Изображение на странице акции *</h5>
                <span><small>будет отображаться на странице акции (1300 * 440 px)</small></span>
        ...
        <div class="row">
            <div class="col-sm-4">
                ...
                <span><small>не обязательно для заполнения (max 1300 * 1000)</small></span>

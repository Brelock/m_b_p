          ...
          <div style="display:flex;
              ...
              <div style="display:flex;
                    ...
                    <div>
                        ...
                        <a class="btn btn-sm btn-outline-primary" href="{{ route('special.requests.index', ['_formOrders' => true]) }}">Очистить фильтры
                        </a>
                    </div>
...
@section('scripts')
  <script>
      ...
      $(".btnSearch").click(function(e){
          e.preventDefault();
          filteredOrders("{{ route('special.requests.index') }}");
      });
      ...
      $(".btn-danger").click(function(e){
          e.preventDefault();
          deleteRequests("{{ route('special.requests.destroyAll') }}");
      });

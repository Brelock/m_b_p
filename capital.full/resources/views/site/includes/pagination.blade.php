    ...
    <ul class="pagination" role="navigation">
        ...
        @else
            <li class="page-item pagination-prev">
                <a href="{{ $paginator->previousPageUrl() }}" rel="nofollow" aria-label="@lang('pagination.previous')" class="page-link icomoon icon-angle"></a>
            </li>
        @endif
        ...
        @if ($paginator->hasMorePages())
            <li class="page-item pagination-next">
                <a href="{{ $paginator->nextPageUrl() }}" rel="nofollow" aria-label="@lang('pagination.next')" class="page-link icomoon icon-angle"></a>
            </li>
        @else

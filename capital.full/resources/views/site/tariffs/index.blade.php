        ...
        <section class="pageSection white-bg">
            <div class="mcontainer">
                ...
                <div class="sectionBlock  toggleBlocks-list animation">
                    @forelse($categories as $category)
                        <div id="tabBlock{{ $category->id }}" class="toggleBlock @if($loop->iteration == 1) active @endif">
                                ...
                                @forelse($category->tariffs as $tariff)
                                    <article class="tariff-item mcol-xs-12 mcol-sm-6 mcol-md-4">
                                        <div class="item-container flex column">
                                            <h3 class="title article-title">{{ __('main.tariff_plan') }} {{ $tariff['title_'.$locale] }}</h3>
                                            ...
                                            <div class="firstLevelWrapper">
                                                ...
                                                <div class="description-container flex column">
                                                    <div class="description">
                                                        ...
                                                        <ul class="conditions">
                                                            <li>{{ $tariff['note_'.$locale] }}</li>
                                                            <li><b>{{ $tariff['rate_'.$locale] }}</b></li>
                                                    ...
                                                    {{--<div class="more-button inversed">--}}
                                                        ...
                                                        {{--</div>--}}
                                                    {{--</div>--}}
                                                  @isset($tariff['link_'.$locale])
                                                    <div class="link">
                                                      <a href="{{ $tariff['link_'.$locale] }}">{{ trans('main.details_tariff_plans') }}</a>
                                                    </div>
                                                  @endisset
                                                </div>
                                            </div>

        ...
        <ul class="countersList">
            <li class="mcol-xs-12">
                <div class="descriptionBlock">
                    ...
                    <div class="counterContainer" data-count="{{ $achievements->years }}">{{ $achievements->years }}</div>
                </div>
            </li>
            <li class="mcol-xs-12">
                <div class="descriptionBlock">
                    <div class="title">{{ trans('main.offices_amount') }}</div>
                    <div class="counterContainer" data-count="{{ $achievements->offices }}">{{ $achievements->offices }}</div>
                </div>
            </li>
            <li class="mcol-xs-12">
                <div class="descriptionBlock">
                    <div class="title">{{ trans('main.cities') }}</div>
                    <div class="counterContainer" data-count="{{ $achievements->cities }}">{{ $achievements->cities }}</div>
                </div>
            </li>
            <li class="mcol-xs-12">
                <div class="descriptionBlock">

                ...
                @forelse($bails as $bail)
                    <article class="mcol-xs-12 mcol-sm-6 mcol-md-4">
                        <div class="item pledge-item main">
                            <a href="{{ route('calculator', ['type' => $bail->type]) }}" class="absolute stretch overlay-link"></a>
                            ...
                            <div class="calculate-button-container">
                                <span href="{{ route('calculator', ['type' => $bail->type]) }}" class="title">{{ trans('main.calculate') }} <i class="icomoon standard-arrow-icon inversed"></i></span>
                            </div>

                            <div class="description-container">
                                <h4 class="title article-title">{{ $bail['title_'.$locale] }}</h4>
                                <div class="description">
                                    <p>{!! nl2br($bail['description_'.$locale]) !!}</p>
                                </div>
                            </div>
                        </div>
                    </article>

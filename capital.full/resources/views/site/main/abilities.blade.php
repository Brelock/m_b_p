        ...
        @forelse($abilities as $ability)
            <article class="mcol-xs-12 mcol-sm-6 mcol-md-3">
                <div class="item pledge-item special more-button overlayed">
                    <a href="{{ route('special.abilities', ['type' => $ability->type]) }}" class="absolute stretch overlay-link"></a>
                    <div class="darkOverlay"></div>

                    <div class="more-button-wrapper">
                        <div class="more-button-container">
                            <a href="{{ route('special.abilities', ['type' => $ability->type]) }}" class="title semi-bold">{{ trans('main.details') }}</a>
                    ...
                    <div class="description-container">
                        ...
                        <div class="description">
                            <p>{!! nl2br($ability['description_'.$locale]) !!}</p>
                        </div>
                    </div>
                </div>
            </article>

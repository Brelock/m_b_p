                            ...
                            <div class="description">
                                <ul>
                                    @foreach($report->documents as $document)
                                        <li>
                                            <a href="{{ route('reports.download', ['document' => $document->path]) }}" class="link-with-icon" alt="скачать">
                                    ...
                                    @endforeach
                                        {{--<li>--}}
                                            {{--<a href="{{ route('reports.download.fake') }}" class="link-with-icon" alt="скачать">--}}
                                                {{--<i class="icomoon icon-doc"></i>--}}
                                                {{--<span><b>Аудиторское заключение за 2018 год</b></span>--}}
                                            {{--</a>--}}
                                        {{--</li>--}}
                                </ul>
                            </div>

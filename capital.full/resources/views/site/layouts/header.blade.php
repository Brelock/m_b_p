        ...
        <div class="mcontainer">
            ...
            <div class="content-wrapper flex wrap">
                ...
                <ul class="section-element social-media-list mcol-xs-12 mcol-md-auto backgroundMock">
                    {{--<li><a href="mailto:{{ $settings->email }}" class="icomoon icon-envelope"></a></li>--}}
                    {{--<li><a href="tel:{{ $settings->viber }}" class="icomoon icon-viber"></a></li>--}}
        ...
        <div class="mcontainer backgroundMock">
            <div class="menuMainWrapper">
                ...
                <div class="menuBlock relative flex center">
                    <a href="{{ route('actions') }}" class="gift-button">
                    ...
                    <div class="credit-block">
                        ...
                        <a href="{{ route('calculator') }}" class="desctop-tc" @if(Route::is('calculator')) class="desctop-tc active" @endif><span>{{ trans('main.calculate') }}</span> <span>{{ trans('main.credit') }}</span></a>
						<!-- <a  class="mobile-tc" href="https://my.lombard-capital.com.ua/login"><span>{{ trans('main.private_office_private') }}</span> <span>{{ trans('main.private_office_office') }}</span></a> -->
{{--                        <a href="#" @if(Route::is('calculator')) class="active" @endif><span>{{ trans('main.calculate') }}</span> <span>{{ trans('main.credit') }}</span></a>--}}
                    </div>
                    ...
                    <nav id="navMenuWrapper" class="navMenuWrapper hiddenContent scale opacityAnimate">
                        <div id="navMenuContainer" class="navMenuContainer">
                            ...
                            <a href="{{ route('actions') }}" class="gift-button mobile-tc">
                                <i class="icomoon icon-present"></i>
                            </a>
...
{{--                                <li @if(Route::is('news')) class="active" @endif><a href="{{ route('news') }}">{{ trans('main.actions') }}</a></li>--}}
                                <li @if(Route::is('special.abilities')) class="active" @endif><a href="{{ route('special.abilities') }}">{{ trans('main.special_abilities') }}</a></li>
{{--                                <li @if(Route::is('clients')) class="active" @endif><a href="{{ route('clients') }}">{{ trans('main.for_clients') }}</a></li>--}}
                                ...
                                <li @if(Route::is('vacancies')) class="active" @endif><a href="{{ route('vacancies') }}">{{ trans('main.career') }}</a></li>
                            </ul>
                            <!--  -->
                            ...
                            <div class="menu-section credit-block-menu">
                                <i class="icomoon icon-calculator"></i>
                                <a href="{{ route('calculator') }}"><span>{{ trans('main.calculate_credit') }}</span></a>
                            </div>

                            <div class="menu-section auth-section">
                                <a href="https://my.lombard-capital.com.ua/login" class="standardButton secondary border-decor">

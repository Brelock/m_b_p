...
class Kernel extends ConsoleKernel
{
    ...
    protected $commands = [
        ...
        \App\Console\Commands\FillMetatags::class,
        \App\Console\Commands\FixCalcTariffTree::class,
        \App\Console\Commands\ParseCalcGadgetsCommand::class,
    ];
...
//            ->everyMinute();
        ...
        $schedule->command('gadgets:parse')->dailyAt('03:00');
    }

...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    handleSubmit: function handleSubmit() {
      var payload = {
        data: this.formData // withFile: !!this.formData.images.length,
  ...
  mounted: function mounted() {
    ...
    window.addEventListener('mouseup', function () {
      if (_this.dropdownyDepartment === true) {
        _this.dropdownyDepartment = false;
      } else if (_this.dropdownyProbe === true) {
        _this.dropdownyProbe = false;
      } else if (_this.dropdownyDiscount === true) {
        _this.dropdownyDiscount = false;
      }
    });
  }
});
    ...
    _c("div", { staticClass: "flex_wrapper" }, [
      ...
      !_vm.visibleSubmitForm
        ? _c(
            "button",
            {
              staticClass: "resetButton button",
              attrs: { type: "button" },
            ...
            [
              _vm._v(
                "\n\t\t\t\t\t\t\t\t " +
                  _vm._s(_vm.messages[_vm.lang].to_back) +
                  "\n\t\t\t\t \t"
              )
            ]
          )

...
$(document).ready(function () {
    ...
    function getAllItems() {
        ...
        axios.get(window.location.origin + window.location.pathname + '/get-departments').then(function (response) {
    ...
    department.chosen().change(function () {
        var city_id = city.chosen().val();
        var department_id = department.chosen().val();
        if (department_id !== 'all') {
            axios.get(window.location.origin + window.location.pathname + '/get-departments?city=' + city_id + '&department=' + department_id).then(function (response) {
    ...
    function setFetchedDepartmentsToChosenSelect(response) {
        if (response) {
            clear();
            _.map(response.data, function (item) {
                var _makeDepartmentInfoFi2 = makeDepartmentInfoFieldsFromItem(item),
                    transportedField = _makeDepartmentInfoFi2.transportedField,
                    phoneField = _makeDepartmentInfoFi2.phoneField,
                    workTimeField = _makeDepartmentInfoFi2.workTimeField;
        ...
        this.setCluster = function () {
            ...
            var markers = locations.map(function (item, i) {
                ...
                google.maps.event.addListener(marker, 'click', function () {
                    ...
                    var $lombardMapImage = $('.lombard-map__image');
    ...
    function CreateMapDepartment(mapID, location) {
        ...
        var lat = $('#departmentMap').data('lat');
        var lng = $('#departmentMap').data('lng');

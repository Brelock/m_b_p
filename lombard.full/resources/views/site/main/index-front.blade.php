...
<div class="main-wrap-calc">
    <credit-calculator-container :show-tabs="true"></credit-calculator-container>
</div>
...
<section class="new-action-section small-slide-section">
    <div class="mcontainer">
        @include('site.includes.main-smail-slide-front')
    </div>
</section>
...
<section class="new-news-section small-slide-section">
    <div class="mcontainer">
        @include('site.includes.main-smail-slide-front-news')

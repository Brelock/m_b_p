...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/siteApp.css') }}">
...
<body data-locale="{{ $locale }}">
  ...
  <div class="mainWrapper">
    <div class="contentWrapper">
      @include('site.layouts.headers.header-front')
      ...
      @if(Route::currentRouteName() != '404')
          @include('site.layouts.footers.footer-front')
      @endif
  </div>
  ...
  @include('site.includes.review-modal-front')

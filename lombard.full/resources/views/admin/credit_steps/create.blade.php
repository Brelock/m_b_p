        ...
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-pane fade" id="uk" role="tabpanel" aria-labelledby="uk-tab"><br>
                <div class="row">
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Заголовок * <small>(украинский вариант)</small> <img src="/img/ua.svg" alt="" style="width: 1.5em;"></label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-group">
                            <label>Длительность процедуры * <small>(украинский вариант)</small> <img src="/img/ua.svg" alt="" style="width: 1.5em;"></label>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label>Описание * <small>(украинский вариант)</small> <img src="/img/ua.svg" alt="" style="width: 1.5em;"></label>

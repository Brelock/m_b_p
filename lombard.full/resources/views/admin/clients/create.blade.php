    ...
    <form method="POST"
        ...
        <div class="tab-content" id="myTabContent">
            <div class="tab-pane fade show active" id="ru" role="tabpanel" aria-labelledby="ru-tab"><br>
                ...
                @isset($client)
                    @include('admin.includes.seo_tags_ru', array('page' => $client ))
                @else
            ...
            <div class="tab-pane fade" id="uk" role="tabpanel" aria-labelledby="uk-tab"><br>
                ...
                @isset($client)
                    @include('admin.includes.seo_tags_uk', array('page' => $client ))
                @else
        ...
        <div class="row">
            <div class="col-sm-6">
                <div class="form-group">
                    <h5>Изображение *</h5>
                    <span><small>будет отображаться в списке (418 * 320 px)</small></span>
                    <input type="file" name="photo" class="form-control" @if(!isset($client->photo))  @endif/>
                </div>
            </div>
            <div class="col-sm-6">
                <h5>Изображения для галереи</h5>
                <span><small>не обязательно для заполнения (max 1300 * 1000 px)</small></span>

...
@section('content')
    ...
    <form method="POST"
        ...
        <div class="tab-content" id="myTabContent">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="button_name_ru" class="form-control"
                            @isset($banner)
                                value="{{ old('button_name_ru') ? old('button_name_ru') : $banner->button_name_ru }}"
                            @else
                                value="{{ old('button_name_ru') }}"
                            @endisset
                            >
                        </div>
                    </div>
            ...
            <div class="tab-pane fade" id="uk" role="tabpanel" aria-labelledby="uk-tab"><br>
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label>Название кнопки *  <small>(украинский вариант)</small></label>
                            <input type="text" name="button_name_uk" class="form-control"
                            @isset($banner)
                                value="{{ old('button_name_uk') ? old('button_name_uk') : $banner->button_name_uk }}"
                            @else
                                value="{{ old('button_name_uk') }}"
                            @endisset
                            >
                        </div>
                    </div>
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    <h6>Изображение * (1920 * 1080 px)</h6>
            ...
            <div class="col-sm-4">
                <div class="form-group">
                    <h6>Изображение для моб.устройств (665х500 px)</h6>
                    <input type="file" name="image_mobile" class="form-control" @if(!isset($banner) ) {{ 'required' }} @endif>
                </div>
                @if(isset($banner->image_mobile))
                    <div class="card card-body bg-light">
                        <img src="{{ asset('storage/images/banners/'.$banner->image_mobile) }}" alt=""   class="img-fluid">
                    </div>
                @endif
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <label>Ссылка для изображения *</label>
                    <input type="text" name="image_link" class="form-control"
                       @isset($banner)
                            value="{{ old('image_link') ? old('image_link') : $banner->image_link }}"
                       @else

...
class ActionController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $actions = Action::orderBy('start_at', 'desc')->paginate($elemsOnPage);
    ...
    {
        return view('admin.actions.create', ['action' => $this->action]);
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.actions.create', ['action' => $action]);
    }
